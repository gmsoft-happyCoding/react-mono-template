...
<script src="${process.env['business.cdn']}/systemjs/6.14.1/system.min.js"></script>
<script src="${process.env['business.cdn']}/systemjs/6.14.1/extras/amd.min.js"></script>
<script src="${process.env['business.cdn']}/systemjs/6.14.1/extras/use-default.min.js"></script>`;
